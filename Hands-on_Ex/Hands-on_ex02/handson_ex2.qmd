...
[**ggrepel**](https://ggrepel.slowkow.com/) ![](https://r4va.netlify.app/chap02/img/image3.jpg){width="55" height="50"} is an extension of **ggplot2** package which provides `geoms` for **ggplot2** to repel overlapping text as in our examples above.
...
## 5.1 Creating Composite Graphics: pathwork methods ![](https://r4va.netlify.app/chap02/img/image4.png){width="56"}
...
-   Kam, T. S. (2024). *Beyond ggplot2 Fundamentals.* <https://r4va.netlify.app/chap02>
